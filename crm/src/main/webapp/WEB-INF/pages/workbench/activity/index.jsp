	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#chckAll").click(function () {
				//如果“全选”按钮时选中状态，则列表中的所有checkbox都选中
			...
			//$("#tBody input[type='checkbox']").on(function () {
				//如果列表中的所有checkbot都选了，那么全选按钮也选中
				//列表中所有的checkbox
			...
			$("#importActivityBtn").click(function () {
				...
				//FormData时ajax提供的接口,可以模拟键值对向后台提交参数
				//最大的优势，既可以提交文本数据,也可以提交二进制文件
				...
				$.ajax({
					...
					data:formData,
					processData:false,//设置ajax向后台提交参数之前，是否把参数统一转换为字符串,默认时true
					contentType:false,//设置ajax向后台提交参数之前，是否把参数统一按照urlencoded编码，默认时true
					type:'post',
					dataType:'json',
					success:function (data) {
						if(data.code=="1"){
