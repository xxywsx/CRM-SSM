...
<%--							</tr>--%>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId"  value="147a865f8cad486dbd2a8da61fba917f">
				<input type="text" class="form-control" id="create-activityName" value="测试02">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="029495ca9c894ef99373846e3842b96c">
